  ...
  return (
    <section className="py-20 sm:py-28 border-t border-neutral-100 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-14">
        ...
        {/* 3 Handhold-Style Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Agent 1: Sensor Agent */}
          <div className="rounded-2xl border border-neutral-200/90 bg-[#FBFBFC] p-7 shadow-sm flex flex-col justify-between hover:border-neutral-300 transition-all">
