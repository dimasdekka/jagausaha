  ...
  return (
    ...
    >
      <motion.div
        ...
        initial={false}
        animate={{
          borderTopLeftRadius: startsGroup ? 20 : 12,
          borderTopRightRadius: startsGroup ? 20 : 12,
          borderBottomLeftRadius: endsGroup ? 20 : 12,
          borderBottomRightRadius: endsGroup ? 20 : 12,
        }}
        transition={reduce ? { duration: 0 } : ROW_TRANSITION}
        className={cn(
          "overflow-hidden border border-neutral-200/80 bg-white shadow-2xs text-neutral-900 transition-colors",
          open && "border-neutral-300 shadow-xs bg-neutral-50/40",
      ...
      >
        ...
        >
          {item.icon ? (
            <span
              className={cn(
                "grid h-7 w-7 shrink-0 place-items-center text-neutral-500",
                classNames?.icon,
              )}
            >
              {item.icon}
          ...
          <span
            className={cn(
              "min-w-0 flex-1 text-[15px] font-semibold text-neutral-950 tracking-tight",
              classNames?.title,
            )}
          >
            {item.title}
          ...
          <motion.span
            ...
            className={cn(
              "grid h-6 w-6 shrink-0 place-items-center text-neutral-400 group-hover:text-neutral-700",
              classNames?.chevron,
            )}
          >
        ...
        >
          ...
          >
            <div
              className={cn(
                "text-[14px] leading-relaxed text-neutral-600 font-normal border-t border-neutral-100 pt-3",
