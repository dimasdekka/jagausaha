...
export const MatrixOrb: React.FC<MatrixOrbProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <span className="mt-2 text-[11px] font-mono font-semibold tracking-wide uppercase text-emerald-700 bg-emerald-50 border border-emerald-200/80 px-2.5 py-0.5 rounded-full">
