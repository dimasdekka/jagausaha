...
Cohesion: 0.06
Nodes (32): devDependencies, autoprefixer, oxlint, postcss, tailwindcss, @types/node, @types/react, @types/react-dom (+24 more)
...
Cohesion: 0.40
Nodes (4): ActionFeed(), ActionFeedProps, MotionButton, MotionButtonProps
...
Cohesion: 0.14
Nodes (14): Header(), HeaderProps, AnimatedNumberProps, WhatsAppModal(), WhatsAppModalProps, EASE_DRAWER, EASE_IN_OUT, EASE_OUT (+6 more)
...
Cohesion: 0.17
Nodes (12): DecisionIntelligenceCard(), DecisionIntelligenceProps, DecisionStudio(), DecisionStudioProps, PresetScenario, AnimatedNumber(), PulseCards(), PulseCardsProps (+4 more)
...
### Community 35 - "react"
Cohesion: 0.18
Nodes (15): PRESETS, PulseData, FAQSection(), FeatureAgents(), Footer(), HeroSection(), HeroSectionProps, HeroVisual3D() (+7 more)
...
### Community 44 - "cn"
Cohesion: 0.07
Nodes (33): BoardUIAreaChart(), BoardUIAreaChartProps, ChartDataPoint, FinalCTA(), FinalCTAProps, ARROW_OPACITY, ExpandingArrowButton, ExpandingArrowButtonProps (+25 more)
...
Cohesion: 0.18
Nodes (11): dependencies, border-beam, clsx, framer-motion, gsap, lucide-react, react, react-dom (+3 more)

### Community 50 - "input.tsx"
Cohesion: 0.33
Nodes (4): HowItWorksProps, Input, InputClassNames, InputProps
...
- **Why does `react` connect `react` to `matrix-orb.tsx`, `package.json`, `CountUp.tsx`, `SpotlightCard.tsx`, `button.tsx`, `TrajectoryChart.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `cn`, `BoardUIAgentThinking.tsx`, `framer-motion`, `DecisionStudio.tsx`, `bouncy-accordion.tsx`, `input.tsx`, `ShinyText.tsx`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `matrix-orb.tsx`, `react`, `button.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `bouncy-accordion.tsx`, `DecisionStudio.tsx`, `input.tsx`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `react` to `matrix-orb.tsx`, `package.json`, `button.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `BoardUIAgentThinking.tsx`, `DecisionStudio.tsx`, `bouncy-accordion.tsx`, `input.tsx`?**
