...
### Community 6 - "react"
Cohesion: 0.36
Nodes (6): ActionFeed(), ActionFeedProps, TiltCard(), TiltCardProps, useHoverCapable(), react
...
Cohesion: 0.18
Nodes (11): FAQSection(), WhatsAppModal(), WhatsAppModalProps, EASE_DRAWER, EASE_IN_OUT, EASE_OUT, EASE_OUT_CSS, SPRING_GLIDE (+3 more)
...
Cohesion: 0.20
Nodes (11): DecisionIntelligenceCard(), DecisionIntelligenceProps, DecisionStudio(), DecisionStudioProps, PresetScenario, HeaderProps, MotionButton, MotionButtonProps (+3 more)
...
Cohesion: 0.25
Nodes (6): FinalCTA(), FinalCTAProps, ARROW_OPACITY, ExpandingArrowButton, ExpandingArrowButtonProps, SPRING_LAYOUT
...
### Community 34 - "input.tsx"
Cohesion: 0.29
Nodes (6): HowItWorks(), HowItWorksProps, Input, InputClassNames, InputProps, gsap

### Community 35 - "lucide-react"
Cohesion: 0.47
Nodes (4): HeroSection(), HeroSectionProps, HeroVisual3D(), lucide-react

### Community 41 - "animated-badge.tsx"
Cohesion: 0.13
Nodes (14): AnimatedBadge(), AnimatedBadgeProps, AnimatedBadgeSize, AnimatedBadgeStatus, ICON_CLASS, ICON_ROLL_VARIANTS, ICONS, SIZE_CLASS (+6 more)
...
Cohesion: 0.24
Nodes (7): PRESETS, PulseData, FeatureAgents(), Footer(), Header(), TerminalDrawer(), TerminalDrawerProps
...
## Knowledge Gaps
- **270 isolated node(s):** `WhatsAppModalProps`, `BoardUIAgentThinkingProps`, `ThinkingStep`, `DecisionIntelligenceProps`, `DecisionStudioProps` (+265 more)
...
- **Why does `react` connect `react` to `expanding-arrow-button.tsx`, `matrix-orb.tsx`, `package.json`, `lucide-react`, `input.tsx`, `CountUp.tsx`, `ShinyText.tsx`, `SpotlightCard.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `TrajectoryChart.tsx`, `cn`, `App.tsx`, `BoardUIAgentThinking.tsx`, `framer-motion`, `DecisionStudio.tsx`?**
