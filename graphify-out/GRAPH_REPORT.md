...
5. `framer-motion` - 19 edges
6. `compilerOptions` - 18 edges
7. `6. FIFTEEN UNCONVENTIONAL OUT-OF-THE-BOX AGENT CAPABILITIES` - 17 edges
...
### Community 6 - "ActionFeed.tsx"
Cohesion: 0.24
Nodes (8): ActionFeed(), ActionFeedProps, FeatureAgents(), TiltCard(), TiltCardProps, SPRING_MOUSE, useHoverCapable(), gsap
...
Cohesion: 0.18
Nodes (11): AnimatedNumber(), AnimatedNumberProps, WhatsAppModal(), WhatsAppModalProps, EASE_DRAWER, EASE_IN_OUT, EASE_OUT, EASE_OUT_CSS (+3 more)
...
Cohesion: 0.16
Nodes (14): DecisionIntelligenceCard(), DecisionIntelligenceProps, DecisionStudio(), DecisionStudioProps, PresetScenario, HeaderProps, MotionButton, MotionButtonProps (+6 more)
...
### Community 32 - "react"
Cohesion: 0.21
Nodes (9): FinalCTA(), FinalCTAProps, HeroSectionProps, HeroVisual3D(), ARROW_OPACITY, ExpandingArrowButton, ExpandingArrowButtonProps, SPRING_LAYOUT (+1 more)
...
### Community 34 - "19. FINAL CHALLENGE: THE 7-DAY HACKATHON EXECUTION PLAN"
Cohesion: 0.33
...
### Community 35 - "16. RED TEAM THE IDEA: BRUTAL JUDGE OBJECTIONS & DEFENSES"
Cohesion: 0.40
...
### Community 40 - "12. THE PERFECT 3-MINUTE HACKATHON DEMO SCRIPT"
Cohesion: 0.67
...
Cohesion: 0.15
Nodes (12): AnimatedBadge(), AnimatedBadgeProps, AnimatedBadgeSize, AnimatedBadgeStatus, ICON_CLASS, ICON_ROLL_VARIANTS, ICONS, SIZE_CLASS (+4 more)

### Community 42 - "1. START FROM THE PROBLEM — NOT THE SOLUTION"
Cohesion: 0.67
Nodes (3): 1.1 Field Realities of Indonesian UMKM, 1.2 Problem Ranking Matrix, 1. START FROM THE PROBLEM — NOT THE SOLUTION

### Community 43 - "2. CRITICAL EVALUATION OF THE ORIGINAL IDEA"
Cohesion: 0.67
Nodes (3): 2.1 The Original Hypothesis, 2.2 Brutal Reality Check & Weak Assumptions, 2. CRITICAL EVALUATION OF THE ORIGINAL IDEA

### Community 44 - "cn"
Cohesion: 0.09
Nodes (26): BoardUIAreaChart(), BoardUIAreaChartProps, ChartDataPoint, Marquee(), MarqueeProps, reducedVariants, SharedLayoutBg, SharedLayoutBgProps (+18 more)

### Community 45 - "App.tsx"
Cohesion: 0.17
Nodes (11): PRESETS, PulseData, FAQSection(), Footer(), Header(), HeroSection(), HowItWorks(), HowItWorksProps (+3 more)

### Community 46 - "framer-motion"
Cohesion: 0.29
Nodes (3): BlurTextProps, MagnetProps, framer-motion

### Community 47 - "3. COMPETITIVE LANDSCAPE & LOCAL ADAPTATION"
Cohesion: 0.67
...
### Community 48 - "9. SAFETY ARCHITECTURE & FINANCIAL TRUST BOUNDARIES"
Cohesion: 0.67
...
## Knowledge Gaps
- **270 isolated node(s):** `AnimatedNumberProps`, `WhatsAppModalProps`, `BoardUIAgentThinkingProps`, `ThinkingStep`, `DecisionIntelligenceProps` (+265 more)
...
- **Why does `react` connect `react` to `matrix-orb.tsx`, `package.json`, `CountUp.tsx`, `ShinyText.tsx`, `ActionFeed.tsx`, `SpotlightCard.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `TrajectoryChart.tsx`, `cn`, `App.tsx`, `BoardUIAgentThinking.tsx`, `framer-motion`, `DecisionStudio.tsx`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `JAGAUSAHA: AI Autonomous Financial Guardian & Decision Sandbox for Indonesian UMKM` connect `JAGAUSAHA: AI Autonomous Financial Guardian & Decision Sandbox for Indonesian UMKM` to `19. FINAL CHALLENGE: THE 7-DAY HACKATHON EXECUTION PLAN`, `16. RED TEAM THE IDEA: BRUTAL JUDGE OBJECTIONS & DEFENSES`, `14. TECHNICAL ARCHITECTURE & FRAMEWORK EVALUATION`, `12. THE PERFECT 3-MINUTE HACKATHON DEMO SCRIPT`, `18. FINAL PRODUCT SYNTHESIS`, `1. START FROM THE PROBLEM — NOT THE SOLUTION`, `2. CRITICAL EVALUATION OF THE ORIGINAL IDEA`, `6. FIFTEEN UNCONVENTIONAL OUT-OF-THE-BOX AGENT CAPABILITIES`, `3. COMPETITIVE LANDSCAPE & LOCAL ADAPTATION`, `9. SAFETY ARCHITECTURE & FINANCIAL TRUST BOUNDARIES`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `MatrixOrb()` connect `matrix-orb.tsx` to `DecisionStudio.tsx`, `cn`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **What connects `AnimatedNumberProps`, `WhatsAppModalProps`, `BoardUIAgentThinkingProps` to the rest of the system?**
