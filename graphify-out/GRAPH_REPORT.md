...
Cohesion: 0.18
Nodes (10): BoardUIAreaChart(), BoardUIAreaChartProps, ChartDataPoint, DashboardPage(), DashboardPageProps, AnimatedNumber(), AnimatedNumberProps, PulseCards() (+2 more)
...
Cohesion: 0.16
Nodes (12): CommandPalette(), CommandPaletteProps, PANEL_SPRING, WhatsAppModalProps, EASE_DRAWER, EASE_IN_OUT, EASE_OUT, EASE_OUT_CSS (+4 more)
...
Cohesion: 0.24
Nodes (10): DecisionIntelligenceCard(), DecisionIntelligenceProps, DecisionStudioProps, PresetScenario, MotionButton, MotionButtonProps, SimulationChatModal(), SimulationChatModalProps (+2 more)
...
Cohesion: 0.17
Nodes (14): PRESETS, PulseData, ActionFeed(), ActionFeedProps, DecisionStudio(), FeatureAgents(), Footer(), HeroSection() (+6 more)

### Community 36 - "19. FINAL CHALLENGE: THE 7-DAY HACKATHON EXECUTION PLAN"
Cohesion: 0.33
...
### Community 38 - "16. RED TEAM THE IDEA: BRUTAL JUDGE OBJECTIONS & DEFENSES"
Cohesion: 0.40
...
### Community 39 - "14. TECHNICAL ARCHITECTURE & FRAMEWORK EVALUATION"
Cohesion: 0.50
...
### Community 43 - "12. THE PERFECT 3-MINUTE HACKATHON DEMO SCRIPT"
Cohesion: 0.67
...
### Community 45 - "1. START FROM THE PROBLEM — NOT THE SOLUTION"
Cohesion: 0.67
...
### Community 47 - "2. CRITICAL EVALUATION OF THE ORIGINAL IDEA"
Cohesion: 0.67
...
### Community 49 - "3. COMPETITIVE LANDSCAPE & LOCAL ADAPTATION"
Cohesion: 0.67
...
### Community 50 - "react"
Cohesion: 0.16
Nodes (10): HowItWorksProps, LoginPage(), LoginPageProps, Input, InputClassNames, InputProps, SpotlightCardProps, JagaUsahaLogo() (+2 more)

### Community 51 - "9. SAFETY ARCHITECTURE & FINANCIAL TRUST BOUNDARIES"
Cohesion: 0.67
...
## Knowledge Gaps
- **286 isolated node(s):** `CommandPaletteProps`, `WhatsAppModalProps`, `BoardUIAgentThinkingProps`, `ThinkingStep`, `DecisionIntelligenceProps` (+281 more)
...
- **Why does `react` connect `react` to `expanding-arrow-button.tsx`, `matrix-orb.tsx`, `package.json`, `App.tsx`, `text-reveal.tsx`, `Header.tsx`, `DashboardPage.tsx`, `CountUp.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `ShinyText.tsx`, `cn`, `TrajectoryChart.tsx`, `BoardUIAgentThinking.tsx`, `framer-motion`, `DecisionStudio.tsx`, `bouncy-accordion.tsx`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `expanding-arrow-button.tsx`, `matrix-orb.tsx`, `text-reveal.tsx`, `Header.tsx`, `DashboardPage.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `bouncy-accordion.tsx`, `DecisionStudio.tsx`, `react`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `App.tsx` to `matrix-orb.tsx`, `package.json`, `Header.tsx`, `DashboardPage.tsx`, `animated-toast-stack.tsx`, `animated-badge.tsx`, `ease.ts`, `BoardUIAgentThinking.tsx`, `DecisionStudio.tsx`, `bouncy-accordion.tsx`, `react`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **What connects `CommandPaletteProps`, `WhatsAppModalProps`, `BoardUIAgentThinkingProps` to the rest of the system?**
