...
## Knowledge Gaps
- **270 isolated node(s):** `TerminalDrawerProps`, `WhatsAppModalProps`, `AgentThinkingProps`, `ThinkingStep`, `BoardUIAgentThinkingProps` (+265 more)
...
- **What connects `TerminalDrawerProps`, `WhatsAppModalProps`, `AgentThinkingProps` to the rest of the system?**
